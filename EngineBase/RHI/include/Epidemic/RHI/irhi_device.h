...
#include <Epidemic/RHI/irhi_resource.h>
...
class IRhiDevice
{
  public:
    ...
    [[nodiscard]] virtual epidemic::foundation::Result<std::shared_ptr<IRhiBuffer>>
    CreateBuffer(const RhiBufferDesc &buffer_desc) = 0;
    [[nodiscard]] virtual epidemic::foundation::Result<std::shared_ptr<IRhiTexture>>
    CreateTexture(const RhiTextureDesc &texture_desc) = 0;
};
} // namespace epidemic::rhi
