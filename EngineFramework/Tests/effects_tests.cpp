...
class CountingHandler final : public IEffectHandler
{
  public:
    ...
    [[nodiscard]] EffectHandlerCapabilities Capabilities() const noexcept override { return {true, false, false, true, true}; }
...
class MaterializedHandler final : public IEffectHandler
{
  public:
    ...
    [[nodiscard]] EffectTypeId Type() const noexcept override { return type_; }
    [[nodiscard]] EffectHandlerCapabilities Capabilities() const noexcept override { return {false, true, true, true, true}; }
