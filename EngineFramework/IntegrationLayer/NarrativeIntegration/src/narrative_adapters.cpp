...
foundation::Result<void> NarrativeSemanticEventAdapter::ProcessDiscovery(narrative::NarrativeService &service,
                                                                         ...
                                                                         GameplayObjectRef area, TypeId topic,
...
foundation::Result<void> NarrativeSemanticEventAdapter::ProcessWorldEvent(narrative::NarrativeService &service,
                                                                          GameplayObjectRef subject,
                                                                          GameplayObjectRef area, TagId event_tag,
                                                                          GameplayContext context) const
{
    narrative::NarrativeEvent event;
...
foundation::Result<void> NarrativeSemanticEventAdapter::ProcessEncounterCompleted(narrative::NarrativeService &service,
...
narrative::NarrativeConsequenceResult NarrativeConsequenceRecorder::Execute(
...
{
    recorded_.push_back(
        RecordedNarrativeConsequence{execution.id, definition.id, execution.thread, context.default_owner});
    return {narrative::ConsequenceExecutionState::Applied, execution.revision};
}

foundation::Result<narrative::ClueId> NarrativeKnowledgeAdapter::CreateClueFromKnowledge(
    narrative::NarrativeService &service, GameplayObjectRef owner, TypeId topic, GameplayObjectRef area,
    std::int64_t confidence, GameplayContext context) const
{
    narrative::ClueRecord clue;
    clue.owner = owner;
    clue.topic = topic;
...
foundation::Result<narrative::RumorId> NarrativeKnowledgeAdapter::CreateRumorFromSharedKnowledge(
    narrative::NarrativeService &service, GameplayObjectRef scope, TypeId topic, std::int64_t confidence,
    GameplayDuration lifetime, GameplayContext context) const
{
