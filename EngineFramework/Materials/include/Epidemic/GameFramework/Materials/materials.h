...
class MaterialService
{
  public:
    ...
    [[nodiscard]] foundation::Result<void> ApplySubstanceExposure(
        ...
        GameplayContext context = {});
    [[nodiscard]] foundation::Result<void> RemoveSubstanceExposure(
        GameplayObjectRef subject,
        MaterialSlotId slot,
        SubstanceId substance,
        GameplayContext context = {});
    ...
    [[nodiscard]] const MaterialSlotState* FindState(GameplayObjectRef subject, MaterialSlotId slot) const noexcept;
  ...
  private:
    ...
    [[nodiscard]] std::int64_t ThresholdValue(const MaterialSlotState& state, const MaterialStimulus& stimulus, ReactionThresholdField field) const noexcept;
